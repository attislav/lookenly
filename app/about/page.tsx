      ...
      <section className="py-24 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex justify-center mb-16">
            <div className="relative w-48 h-48 rounded-full border-2 border-primary overflow-hidden">
              <Image
            ...
            <div className="max-w-3xl mx-auto space-y-8">
              <div>
                ...
                <p className="font-montserrat text-base text-neutral-600 leading-relaxed">
                  ...
                  to a sun-drenched loft in Barcelona, and {siteConfig.site.name} was born—a digital haven
              ...
              <div className="border-t border-secondary pt-8">
                ...
                <p className="font-montserrat text-base text-neutral-600 leading-relaxed">
                  Through {siteConfig.site.name}, I share the pieces, rituals, and ideas that have shaped
      ...
      <section className="py-24 bg-white">
        <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <form className="flex flex-col md:flex-row gap-4 max-w-lg mx-auto">
            ...
            <button
              type="submit"
              className="bg-primary text-white px-10 py-4 font-montserrat text-sm tracking-widest uppercase hover:bg-primary transition-colors duration-300"
            >
              Subscribe
            </button>
          </form>
